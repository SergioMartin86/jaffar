...
void __pascal far load_chtab_from_file(int chtab_id, int resource,
                                       const char near *filename,
                                       int palette_bits);
...
void __pascal far load_intro(int which_imgs, void far (*func)(),
                             int free_sounds);
...
void __pascal far show_hof_text(rect_type far *rect, int x_align, int y_align,
                                const char *text);
...
void __pascal far get_row_collision_data(short row, sbyte *row_coll_room_ptr,
...
short __pascal far trigger_1(short target_type, short room, short tilepos,
                             short button_type);
...
int __pascal far get_tile_to_draw(int room, int column, int row, byte *ptr_tile,
